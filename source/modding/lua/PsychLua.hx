...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('downscroll', Init.trueSettings.get('Downscroll'));
		set('framerate', Init.trueSettings.get('ramerate Cap'));
		set('ghostTapping',Init.trueSettings.get('Ghost Tapping'));
		...
		Lua_helper.add_callback(lua, "callScript", function(?luaFile:String, ?funcName:String, ?args:Array<Dynamic>){
			...
			if(luaFile.endsWith(".psych.lua"))cervix=luaFile;
			var doPush = false;
			#if MODS_ALLOWED
		...
		Lua_helper.add_callback(lua, "doTweenX", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			...
			if(penisExam != null) {
                if (ease == null){
                    PlayState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {x: value}, duration, {ease: FlxEase.linear,
		...
		Lua_helper.add_callback(lua, "doTweenY", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			...
			if(penisExam != null) {
                if (ease == null){
                    PlayState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {y: value}, duration, {ease: FlxEase.linear,
                        onComplete: function(twn:FlxTween) {
                            PlayState.instance.callOnLuas('onTweenCompleted', [tag]);
                            PlayState.instance.modchartTweens.remove(tag);
                        }
		...
		Lua_helper.add_callback(lua, "doTweenAngle", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			...
			if(penisExam != null) {
                if (ease == null){
                    PlayState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {angle: value}, duration, {ease: FlxEase.linear,
                        onComplete: function(twn:FlxTween) {
                            PlayState.instance.callOnLuas('onTweenCompleted', [tag]);
                            PlayState.instance.modchartTweens.remove(tag);
                        }
		...
		Lua_helper.add_callback(lua, "doTweenAlpha", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			...
			if(penisExam != null) {
                if (ease == null){
                    PlayState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {alpha: value}, duration, {ease: FlxEase.linear,
                        onComplete: function(twn:FlxTween) {
                            PlayState.instance.callOnLuas('onTweenCompleted', [tag]);
                            PlayState.instance.modchartTweens.remove(tag);
                        }
		...
		Lua_helper.add_callback(lua, "doTweenZoom", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
			...
			if(penisExam != null) {
                if (ease == null){
                    PlayState.instance.modchartTweens.set(tag, FlxTween.tween(penisExam, {zoom: value}, duration, {ease: FlxEase.linear,
                        onComplete: function(twn:FlxTween) {
                            PlayState.instance.callOnLuas('onTweenCompleted', [tag]);
                            PlayState.instance.modchartTweens.remove(tag);
                        }
		...
		Lua_helper.add_callback(lua, "doTweenColor", function(tag:String, vars:String, targetColor:String, duration:Float, ease:String) {
			...
			if(penisExam != null) {
                ...
                if (ease == null){
                    PlayState.instance.modchartTweens.set(tag, FlxTween.color(penisExam, duration, curColor, color, {ease: FlxEase.linear,
                        onComplete: function(twn:FlxTween) {
                            PlayState.instance.callOnLuas('onTweenCompleted', [tag]);
                            PlayState.instance.modchartTweens.remove(tag);
                        }
	...
	function getFlxEaseByString(?ease:String = '') {
		switch(ease.toLowerCase().trim()) {
			...
			case 'quadInOut': return FlxEase.quadOut;
